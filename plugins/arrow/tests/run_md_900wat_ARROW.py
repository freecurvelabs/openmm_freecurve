...
simulation.reporters.append(DCDReporter('wat900_arrow_05fs.dcd', 2000))
simulation.reporters.append(StateDataReporter(stdout, 20, time=True,step=True, potentialEnergy=True, temperature=True))
simulation.reporters.append(StateDataReporter("wat900_md_05fs_nohr.out", 10, step=True, potentialEnergy=True, temperature=True))
